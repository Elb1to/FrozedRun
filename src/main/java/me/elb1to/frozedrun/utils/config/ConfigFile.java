package me.elb1to.frozedrun.utils.config;
...
public class ConfigFile {
    ...
    public ConfigFile(String name) {
        this.name = name;
        this.file = new File(FrozedUHCRun.getInstance().getDataFolder(), name + ".yml");
        if (!this.file.exists()) {
            FrozedUHCRun.getInstance().saveResource(name + ".yml", false);
        }
